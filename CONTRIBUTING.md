...
If applicable, see if the bug occurs in Scratch itself. Bugs that exist in Scratch are Scratch bugs and should be submitted to Scratch, not to CodeForm.

CodeForm bugs should never be reported to the Scratch "Bugs & Glitches" forum. Instead, you should report bugs by either:
...
When submitting the pull request, make sure that you set the base repository to CodeForm and not Scratch as GitHub is sometimes inconsistent about this. For example, a pull request to the CodeForm VM should be made against CodeForm/scratch-vm, not scratchfoundation/scratch-vm.

## Translations

See https://docs.codeform.gold.edu/translate
